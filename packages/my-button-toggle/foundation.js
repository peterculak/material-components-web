...
class MyRedblueToggleFoundation extends MDCFoundation {
  ...
  constructor(adapter) {
    super(Object.assign(MyRedblueToggleFoundation.defaultAdapter, adapter));
    this.toggled_ = false;
...
export default MyRedblueToggleFoundation;
